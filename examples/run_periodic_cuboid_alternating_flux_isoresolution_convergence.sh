...
# Example:
#   NPROCS_P4_M1=1 NPROCS_P4_M2=2 NPROCS_P4_M3=4 ./examples/run_periodic_cuboid_alternating_flux_isoresolution_convergence.sh
...
run_case() {
    ...
    echo "Running periodic cuboid alternating-flux isoresolution case:"
...
for mesh_level in "${MESH_LEVELS[@]}"; do
    for order in "${ORDERS[@]}"; do
        ...
        esprk_order=$((order + 1))
        output_dir="${OUTPUT_ROOT}/periodic_cuboid_af_p${order}_m${mesh_level}"
